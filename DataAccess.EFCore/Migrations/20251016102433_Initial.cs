        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupCreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    LastMessageSender = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SeenBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friends_Users_UserA",
                        column: x => x.UserA,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Friends_Users_UserB",
                        column: x => x.UserB,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friends_UserA",
                table: "Friends",
                column: "UserA");

            migrationBuilder.CreateIndex(
                name: "IX_Friends_UserB",
                table: "Friends",
                column: "UserB");
